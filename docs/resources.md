...
- **课程内容**：
  ...
  - CS Discoveries（计算机科学探索）
  - CS Principles（计算机科学原理）
...
- **学习资源**：
  ...
  - [ScratchJr](https://www.scratchjr.org/)（5-7 岁）
  - [Scratch Wiki](https://en.scratch-wiki.info/)

#### Khan Academy
- **网址**：https://www.khanacademy.org/computing
- **适用年龄**：全年龄段
- **特色**：
  - 非营利教育平台
  - 完全免费
...
#### PyCharm Edu
- **官网**：https://www.jetbrains.com/pycharm-edu/
- **特色**：
  - Python 专用 IDE
  - 教育版免费
  - 智能代码补全
...
#### mBlock
- **官网**：https://www.mblock.cc/
- **特色**：
  - 基于 Scratch
  - 支持 Arduino、Micro:bit
  - 图形化 + Python
  - 硬件编程
...
2. **《Head First HTML 与 CSS》**
   - 适合：初学者
   - 特点：图文并茂

3. **《你不知道的 JavaScript》系列**
   - 适合：进阶学习
   - 特点：深入原理

#### Scratch 方向
1. **《动手玩转 Scratch 3.0 编程》**
   - 适合：8-12 岁
   - 特点：项目式学习
...
- **特色**：
  ...
  - Python / Scratch 编程
- **教育资源**：
  - Raspberry Pi Foundation 课程
  - 树莓派实验室

#### Micro:bit
- **官网**：https://microbit.org/
- **特色**：
  - BBC 教育板
  - 易于上手
  - MakeCode 图形化编程
...
- **树莓派项目**：https://projects.raspberrypi.org/
- **Micro:bit 教程**：https://microbit.org/projects/
...
- **[Roadmap.sh](https://roadmap.sh/)**：开发者学习路线
- **[GitHub Learning Lab](https://github.com/apps/github-learning-lab)**：GitHub 学习
- **[Exercism](https://exercism.org/)**：代码练习和指导
